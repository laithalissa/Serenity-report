...
\subsection{Simplicity of graphics libraries}
...
so the measures for success are not as easily determined. The ideal outcome for
the project is an enjoyable game that meets the requirements described in section
\ref{section:requirements}. Along the way it would be good to discover aspects
of game development that are improved, or made harder, by the use of a functional
programming language. Unfortunately, measuring these things will not be simple.
However, the use of playtesters will help determine if the game is fun to play
and it is hoped that development diaries will be able to track drawbacks and
