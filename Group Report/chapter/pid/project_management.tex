...
Cabal is the Haskell package manager and build system. It manages dependancies, controls testing, and even allows for delivery via Hackage. 

\subsection{Whiteboard}
The project team still finds it extremely useful to brainstorm and refine ideas, meetings and programming sessions are routinely schedule in the vicinity of white boards.
