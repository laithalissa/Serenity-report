...
% Scala is increasingly popular, helped ... XXX presumably something to do with JVM?
...
As mentioned, there already exist games written in functional languages. Probably the most well known is \emph{Raincat}\sidenote{\url{raincat.bysusanlin.com/}} written in Haskell and developed by Carnegie Mellon students in 2008. There is also a game company, \emph{ipwn studios}, who exclusively use Haskell for their products.\sidenote{ipwnstudios.com/}
