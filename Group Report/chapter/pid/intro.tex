...
% mention that graphics, sounds, and physics don't imply good gameplay, intro existing games
...
Faster Than Light, a turn based strategy game with Real Time battles, lets the player become the captain of a starship.
...
At each jump random encournters occur such as
