...
% Book metadata
\title{Game \mbox{Development} in \mbox{Haskell} --- \\A \mbox{Practical} \\\mbox{Investigation}}

\author[Laith Alissa, Jon Cave, Joseph Siddall, Vic Smith]{\mbox{Laith Alissa}, \mbox{Jon Cave}, \mbox{Joseph Siddall},\\ \mbox{Vic Smith}}
...
\newcommand{\containstables}[1]
{\addcontentsline{lot}{chapter}{#1 \vspace{10pt}}
}
...
\input{lambdaTex}
\setlength{\hsleftskip}{0em}
%\renewcommand{\afterhs}{\vspace{1em}}

\newenvironment{haskell}[0]
{\vspace{-3pt}
> 
}
{\vspace{-1em}
...
\newcommand{\anote}{\hspace{-1em}$\leftarrow$}

\newcommand{\scalenote}[1]{\scalebox{0.8}{#1}} 

\newcommand{\hasklisting}[3]{
\vspace{-1em}
\begin{listing}{#1}{#2}{#3}{language=haskell}
\end{listing}
\vspace{-1em}
} 
