...
\begin{itemize}
\item go directory to C across open space
\item goto Planet B which is close, then use its space lane to Planet C
\item goto space lane between planet A and B and use it to got to B then use space lane to get to C.
\end{itemize}
