...
\begin{margintable}
    ...
    \end{tabular}
    	\vspace{1em}
	\caption[Update message statistics]{Size of each update message and it's average frequency per game step.}
...
\begin{margintable}[2em]
    ...
    \end{tabular}
    	\vspace{1em}
	\caption[Estimation of network requirements]{Estimates kB/sec sent across network for varying number of game steps per second($S$), and number of clients($N$).}
